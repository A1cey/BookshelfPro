...
public class BookAuthor extends TableImpl<BookAuthorRecord> {
     ...
     */
    public final TableField<BookAuthorRecord, UUID> BOOK_ID = createField(DSL.name("book_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.book_author.name</code>.
     */
    public final TableField<BookAuthorRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public List<ForeignKey<BookAuthorRecord, ?>> getReferences() {
        return Arrays.asList(Keys.BOOK_AUTHOR__BOOK_AUTHOR_BOOK_ID_FKEY);
    }
